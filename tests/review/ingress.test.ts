...
function setupReviewPending(): {
  ...
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "task.created", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "task.validation.started", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "task.validation.passed", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "workspace.lock.requested", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "workspace.lock.acquired", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "agent.spawn.started", payload: {}, fingerprint: fp });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "agent.completed", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "evidence.diff.collected", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "verification.completed", payload: {} });
  eventStore.append({ taskId: TASK_ID, attemptId: "att-1", type: "review.requested", payload: {} });
